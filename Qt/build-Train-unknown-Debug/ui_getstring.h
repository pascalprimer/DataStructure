...
public:
    ...
    void setupUi(QDialog *GetString)
    {
        ...
        label->setGeometry(QRect(40, 70, 161, 21));
    ...
    void retranslateUi(QDialog *GetString)
    {
        ...
        label->setText(QApplication::translate("GetString", "<html><head/><body><p><span style=\" font-size:12pt;\">\350\257\267\350\276\223\345\205\245</span></p></body></html>", 0));
