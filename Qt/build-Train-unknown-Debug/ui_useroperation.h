...
public:
    ...
    void setupUi(QDialog *UserOperation)
    {
        ...
        chargeButton->setGeometry(QRect(210, 200, 99, 27));
        ...
        infoButton = new QPushButton(UserOperation);
        infoButton->setObjectName(QStringLiteral("infoButton"));
        infoButton->setGeometry(QRect(60, 50, 99, 27));
        chargeButton_2 = new QPushButton(UserOperation);
        chargeButton_2->setObjectName(QStringLiteral("chargeButton_2"));
        chargeButton_2->setGeometry(QRect(210, 150, 99, 27));
    ...
    void retranslateUi(QDialog *UserOperation)
    {
        ...
        logButton->setText(QApplication::translate("UserOperation", "\346\237\245\347\234\213\346\227\245\345\277\227", 0));
        ...
        infoButton->setText(QApplication::translate("UserOperation", "\344\270\252\344\272\272\344\277\241\346\201\257", 0));
        chargeButton_2->setText(QApplication::translate("UserOperation", "\350\264\246\346\210\267\344\275\231\351\242\235", 0));
    } // retranslateUi
